    ...
    const checkInstructorStatus = async () => {
      try {
        ...
        if (response.isInstructor) {
          ...
          router.push('/instructor/dashboard'); // Chuyển hướng nếu đã là instructor
        }
      } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Trở thành giảng viên tại Mentora</h1>
          <p className="text-lg text-gray-600">Chia sẻ kiến thức của bạn và tạo nguồn thu nhập từ việc dạy học trực tuyến</p>
        </div>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">Tạo và dạy các khóa học theo lịch trình của bạn mà không bị giới hạn.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">Nhận thanh toán cho mỗi học viên đăng ký khóa học của bạn.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">Chia sẻ kiến thức của bạn với hàng ngàn học viên từ khắp nơi trên thế giới.</p>
          </div>
        </div>
      </div>
    </div>
