...
export default function LessonContent({
  ...
  const [activeTab, setActiveTab] = useState<'content' | 'notes' | 'questions'>(
    'content'
  );
              ...
              <div className="flex items-center mt-1">
                <div className="flex items-center">
                  <span className="text-yellow-500 text-sm">
                    ...
                    {Array.from({ length: 5 - Math.ceil(rating || 0) }).map(
                      (_, i) => (
            ...
            {activeTab === 'content' && (
              <div>
                ...
                <p className="text-gray-700">
                  Trong bài học này, bạn sẽ được hướng dẫn chi tiết về cách sử
                  dụng AI để tạo nội dung video hấp dẫn cho kênh YouTube của
                  mình. Chúng ta sẽ tìm hiểu các công cụ AI phổ biến và cách áp
                  dụng chúng vào quy trình sản xuất nội dung.
                </p>
                <div className="mt-4">
                  <h4 className="font-medium mb-2">Nội dung chính:</h4>
                  <ul className="list-disc pl-5 space-y-1">
                    <li>
                      Giới thiệu về các công cụ AI hỗ trợ sáng tạo nội dung
                    </li>
                ...
                <div className="mt-4">
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    ...
                    <li>
                      <a href="#" className="text-blue-600 hover:underline">
                        Danh sách các công cụ AI miễn phí cho người sáng tạo nội
                        dung
                      </a>
                    </li>
                  </ul>
